...
type Phase = 'view' | 'styles' | 'loading' | 'result' | 'saved';
            ...
            <View style={styles.bottom}>
              ...
              <View style={styles.grid}>
                {AI_STYLES.map(s => (
                  <TouchableOpacity
                    key={s.id}
                    style={[styles.styleBtn, selectedStyle?.id === s.id && styles.styleBtnSel]}
              ...
              <TouchableOpacity
                style={[styles.mainBtn, !selectedStyle && styles.mainBtnOff]}
                onPress={handleGenerate}
                disabled={!selectedStyle}>
                <Text style={styles.mainBtnTxt}>
                  {selectedStyle ? `"${selectedStyle.label}"로 생성하기 →` : '스타일 선택 후 생성'}
                </Text>
              </TouchableOpacity>
            </View>
          )}
