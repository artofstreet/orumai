...
const styles = StyleSheet.create({
  ...
  photoEmpty:     { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#F7F7F7' },
  ...
  title:          { fontSize: isWeb ? 18 : 16, fontWeight: '700', color: '#0F172A' },
  addr:           { fontSize: 12, color: '#64748B' },
  price:          { fontSize: isWeb ? 19 : 17, fontWeight: '800' },
